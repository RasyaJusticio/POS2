<template>
  ...
  const items = ref([
    ...
    { id: 5, name: 'Thai Iced Tea', description: 'A sweet, creamy drink made from black tea and sweetened condensed milk.', price: 30000, category: 'minuman', image: thaiImage },
    { id: 6, name: 'Tamarind Juice', description: 'Tangy drink made from tamarind pulp, often sweetened and chilled.', price: 20000, category: 'minuman', image: tamImage },
    ...
    { id: 14, name: 'Tom Kha Kai', description: 'Chicken in a rich coconut milk broth with lemongrass and galangal.', price: 70000, category: 'minuman', image: tomImage },
