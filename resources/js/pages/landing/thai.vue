      ...
      <main class="pos-body">
       ...
       <!-- Fixed cart button -->
        ...
        <aside v-if="isCartVisible" class="pos-cart">
            ...
            <li v-for="cartItem in cart" :key="cartItem.id" class="cart-item">
              ...
              <div class="cart-item-controls">
                <div class="quantity-controls">
                  <button @click="updateQuantity(cartItem, -1)" class="btn btn-outline-secondary" :disabled="cartItem.quantity <= 1">-</button>
          ...
          <router-link v-if="cart.length > 0" :to="{ path: '/landing/payment', query: { cart: JSON.stringify(cart) } }">
